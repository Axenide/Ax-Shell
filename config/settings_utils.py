...
bind = {bind_vars.get('prefix_restart', 'SUPER ALT')}, {bind_vars.get('suffix_restart', 'B')}, exec, killall {APP_NAME}; uwsm-app $(/home/mathias/.config/Ax-Shell/.venv/bin/python {home}/.config/{APP_NAME_CAP}/main.py) # Reload {APP_NAME_CAP}
...
bind = {bind_vars.get('prefix_restart_inspector', 'SUPER CTRL ALT')}, {bind_vars.get('suffix_restart_inspector', 'B')}, exec, killall {APP_NAME}; uwsm-app $(GTK_DEBUG=interactive /home/mathias/.config/Ax-Shell/.venv/bin/python {home}/.config/{APP_NAME_CAP}/main.py) # Restart with inspector
